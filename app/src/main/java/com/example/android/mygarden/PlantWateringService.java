...
public class PlantWateringService extends IntentService {
    ...
    public static final String EXTRA_PLANT_ID = "com.example.android.mygarden.action.water_plant_id";
     ...
     * @see IntentService
     */
    public static void startActionWaterPlants(Context context, int plant_id) {
        Intent intent = new Intent(context, PlantWateringService.class);
        intent.setAction(ACTION_WATER_PLANT);
        intent.putExtra(EXTRA_PLANT_ID, plant_id);
